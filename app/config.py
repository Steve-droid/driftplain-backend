...
class Settings(BaseSettings):
    ...
    # scan. GitOps overrides these local defaults with verified public GHCR digests.
    agent_image: str = "driftplain-agent:latest"
    agent_security_image: str = "driftplain-agent-security:latest"
